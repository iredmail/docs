...
```bash
cd /usr/local/bin/
wget -O iredmail https://dl.iredmail.org/ee/iredmail-enterprise-v1.0.0-linux-amd64
...
```bash
cd /usr/local/bin/
wget -O iredmail https://dl.iredmail.org/ee/iredmail-enterprise-v1.0.0-linux-arm64
chown root:root iredmail
chmod 0500 iredmail
```
...
```bash
cd /usr/local/bin/
wget -O iredmail https://dl.iredmail.org/ee/iredmail-enterprise-v1.0.0-openbsd-amd64
