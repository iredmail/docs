...
1. Download the latest stable release here: <https://dl.iredmail.org/yum/misc/>.
   For example, iRedAPD-3.0.tar.bz2.
1. Upload it to your iRedMail server. Assume it's `/root/iRedAPD-3.0.tar.bz2`.
...
```
# cd /root
# tar xjf iRedAPD-3.0.tar.bz2
# cd iRedAPD-3.0/tools/
