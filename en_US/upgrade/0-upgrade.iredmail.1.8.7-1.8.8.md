# Upgrade iRedMail from 1.8.7 to 1.8.8
...
### Upgrade Roundcube webmail to the latest release (1.7.4)

!!! warning "Roundcube Security Fixes"

    - [Roundcube 1.6.19, 1.7.4 addressed 12 security vulnerabilities.](https://roundcube.net/news/2026/09/06/security-updates-1.6.19-and-1.7.4)
    - [Roundcube 1.6.18, 1.7.3 addressed 11 security vulnerabilities.](https://roundcube.net/news/2026/08/09/security-updates-1.6.18-and-1.7.3)
...
Download the Roundcube 1.7.4 complete package and upgrade, then restart Nginx service:
```
wget https://github.com/roundcube/roundcubemail/releases/download/1.7.4/roundcubemail-1.7.4-complete.tar.gz
tar zxf roundcubemail-1.7.4-complete.tar.gz
cd roundcubemail-1.7.4
