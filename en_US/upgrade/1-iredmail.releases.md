...
---|---|---|---
[1.6.3](https://forum.iredmail.org/) | May 23, 2023 | [Upgrade from iRedMail-1.6.1 or 1.6.2](./upgrade.iredmail.1.6.1-1.6.3.html) |Supports new OpenBSD release (7.3), also contains MySQL structure change.|
