# Upgrade iRedMail from 1.8.4 to 1.8.5
...
### Upgrade Roundcube webmail to the latest release (1.7.3)
...
Download the Roundcube 1.7.3 complete package and upgrade, then restart Nginx service:
```
wget https://github.com/roundcube/roundcubemail/releases/download/1.7.3/roundcubemail-1.7.3-complete.tar.gz
tar zxf roundcubemail-1.7.3-complete.tar.gz
cd roundcubemail-1.7.3
./bin/installto.sh /opt/www/roundcubemail
systemctl restart nginx
```

### Upgrade netdata to the latest stable release (v2.11.0)
