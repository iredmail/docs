...
!!! attention
    ...
    * This document is applicable to `iRedAdmin-Pro-SQL-3.6` (and `3.7`) and
      `iRedAdmin-Pro-LDAP-3.8`. If you're running an old release, please
...
!!! api "`POST`{: .post } `/api/wblist/outbound/blacklist/global`{: .url } `Add new global blacklists for outbound.`{: .comment } `Parameters`{: .has_params_wblist_put }"
...
!!! api "`POST`{: .post } `/api/wblist/outbound/blacklist/<domain>`{: .url } `Add new per-domain blacklists for outbound.`{: .comment } `Parameters`{: .has_params_wblist_put }"
...
!!! api "`POST`{: .post } `/api/wblist/outbound/blacklist/<mail>`{: .url } `Add new per-user blacklists for outbound.`{: .comment } `Parameters`{: .has_params_wblist_put }"
...
!!! api "`PUT`{: .put } `/api/wblist/outbound/blacklist/global`{: .url } `Delete given existing global blacklists for outbound.`{: .comment } `Parameters`{: .has_params_wblist }"
...
!!! api "`PUT`{: .put } `/api/wblist/outbound/blacklist/<domain>`{: .url } `Delete given per-domain blacklists for outbound.`{: .comment } `Parameters`{: .has_params_wblist }"
...
!!! api "`PUT`{: .put } `/api/wblist/outbound/blacklist/<mail>`{: .url } `Delete given per-user blacklists for outbound.`{: .comment } `Parameters`{: .has_params_wblist }"
